...
{
    $req = $connexion->prepare('SELECT nom, prenom, telephone, email, fonction, codeOrganisme '
            . 'FROM employes '
...
function getCodeTuteur($nom,$prenom,$telephone,$email,$fonction,$codeOrganisme,$connexion)
{
    $req = $connexion->prepare('SELECT codeEmploye '
            . 'FROM employes '
            . 'WHERE nom = :nom '
            . 'AND prenom = :prenom '
            ...
            . 'AND codeOrganisme = :codeOrganisme '
            . 'AND typeEmploye = 2');
    $req->bindValue(':nom',$nom);
    $req->bindValue(':prenom',$prenom);
    $req->bindValue(':telephone',$telephone);
