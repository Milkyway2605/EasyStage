...
$anneeUniversitaire = $_SESSION['anneeUniversitaire'];
$nomOrganisme = $_SESSION['nomOrganisme'];
$adresseOrganisme = $_SESSION['adresseOrganisme']
    ...
    <table>
        <tr>
            ...
            <td style='width: 50%; vertical-align: bottom; padding: 20px;'>
                &nbsp; Année universitaire: <?php echo($anneeUniversitaire.' - '.$anneeUniversitaire+1) ?>
            </td>
        </tr>
    </table>
    <br>
        ...
        <table style='margin-top: 20px;'>
            <tr>
                <td style='width: 50%;'>
                    ...
                    <p>
                        Adresse : 314 rue Jules Massenet<br>
                        62400 BETHUNE
                    </p>
                    <p>
                ...
                <td style='width: 50%;'>
                    ...
                    <p>
                        Nom : <?php echo($nomOrganisme); ?>
                    </p>
                    <p>
                        Adresse : <?php echo($adresseOrganisme); ?> <br>
                    </p>
                    <p>
                    ...
                    <p>
                        Lieu du stage (si différent de l'adresse de l'organisme) : <br>
        ...
        <table style="margin-top: 20px;">
            <tr>
                <td>
                    ...
                    <p>
                        Représentant une durée totale de .................. nombre de semains / de mois (rayer la mention inutile)
                    </p>
                    <p>
                        Et correspondant à ....... jours de présence effective dans l'orgnaisme d'accueil.
                    </p>
                    <p>
