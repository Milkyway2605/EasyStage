...
<link href="Application/Ressources/CSS/syntheseStageStyle.css" rel="stylesheet" type="text/css"/>
<link href="Application/Ressources/CSS/syntheseStageResponsive.css" rel="stylesheet" type="text/css"/>
    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <form>
                ...
                <?php
                    include_once 'Application/Modules/syntheseStageModules/filtreModule.php';
                    include_once 'Application/Modules/syntheseStageModules/listeStagesModule.php';
                ?>
            </form>
        </div>
    </div>
...
?>
    ...
    <script src="Application/Ressources/Javascript/syntheseStageScript.js" type="text/javascript"></script>
<?php
